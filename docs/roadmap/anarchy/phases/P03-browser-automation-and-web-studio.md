---
phase: P3
title: "Browser automation and Web Studio"
execution_view_status: BLOCKED_BY_P2_DEPENDENCIES
primary_workers: [D, B, I]
test_center_module: "Browser & Web Studio"
...
- Status: `BLOCKED_BY_P2_DEPENDENCIES`
- Primary workers: Worker D, Worker B, Worker I
...
```text
Take the repo. You are Worker D. Continue the highest-priority dependency-satisfied P3 task.
```
