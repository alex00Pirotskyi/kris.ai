...
Stop only when `NO_LOCAL_EXECUTABLE_WORK` is genuinely true for this execution after live dispatcher resolution, or a hard external boundary prevents all safe continuation.
