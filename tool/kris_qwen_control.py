...
<div class="card"><div class="k">Control token</div><div class="token-row"><input id="tokenValue" type="password" autocomplete="off" placeholder="Paste token from controller token file"><button class="secondary" id="saveToken">Save</button></div><p class="note">Stored only in this browser tab. The server never embeds the token in this page.</p></div>
