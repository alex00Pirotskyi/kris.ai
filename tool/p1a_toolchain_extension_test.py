...
def main() -> int:
    ...
    # V63-R13 diagnostic-bound worker-launcher compile repair. CMake owns Windows SDK macros
    ...
    require("integration/p1-authority-service-v63r13" in workflow and "integration/p1-authority-service-v63r12" not in workflow, "R13 workflow branch boundary invalid")
    ...
    print("P1A V63-R13 hosted-source, shared worker validation, and strict compile-conformance contract: PASS")
    return 0
