...
class CommandPlanningContextRecord {
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
    ...
    'consumedCoordinatorCapabilities': consumedCoordinatorCapabilities.toList()
      ..sort(),
  ...
  factory CommandPlanningContextRecord.fromJson(Map<String, dynamic> json) {
    ...
    return CommandPlanningContextRecord(
      ...
      specification: TaskSpecification.fromJson(
        mapValue(json['specification']),
      ),
      family:
          TaskFamily.values
      ...
      canonicalPlan: UniversalTaskPlan.fromJson(
        mapValue(json['canonicalPlan']),
      ),
      consumedCoordinatorCapabilities: stringList(
        json['consumedCoordinatorCapabilities'],
      ).toSet(),
