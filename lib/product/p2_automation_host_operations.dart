...
final class P2AutomationHostOperations
  ...
  Future<P2OperationSupport> support(String operation) async {
    final response = await _bound(
      'host.support',
      <String, Object?>{'queriedOperation': operation},
    );
  ...
  Future<P2HostOperationResult> applicationOpen(
    ...
    P2EffectBinding binding,
      ...
      _effect(
        binding,
        'application.open',
        <String, Object?>{'target': target, 'arguments': const <String>[]},
      );
  ...
  Future<P2HostOperationResult> applicationClose(
    ...
    P2EffectBinding binding,
      ...
      _effect(
        binding,
        'application.close',
        <String, Object?>{'identity': identity},
      );
  ...
  Future<void> writeClipboard(
    ...
    final response = await _call(
      binding,
      'clipboard.write',
      <String, Object?>{'text': text, 'ordinaryLogContent': false},
    );
