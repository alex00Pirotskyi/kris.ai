...
class ProjectRecord {
  ...
  factory ProjectRecord.fromJson(Map<String, dynamic> json) => ProjectRecord(
    ...
    lastAnalyzeResult: ProjectQualityResult.fromJson(json['lastAnalyzeResult']),
    ...
    lastMeaningfulActivityAt: json['lastMeaningfulActivityAt'] == null
        ? null
        : parseUtc(json['lastMeaningfulActivityAt'], fallback: DateTime.now()),
  );
}
...
enum ProjectLaunchOpenBehavior {
  ...
  String get storageValue => switch (this) {
    ...
    ProjectLaunchOpenBehavior.openExternalBrowser => 'open_external_browser',
