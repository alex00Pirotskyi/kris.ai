  ...
  Future<KernelPreparedPlan> prepareThroughKernel({
    ...
    final prepared = PreparedCommand(
      ...
      requestKey: Sha256.text(canonicalJson(<String, dynamic>{
        ...
        'mode': mode.name,
        'model': model?.toJson(),
        'selfAvailableCapabilities': selfContext.availableCapabilityIds.toList()..sort(),
      })),
    ...
    if (existing == null) {
      ...
      await runtime.audit.append('task_kernel.compiled', prepared.id, <String, dynamic>{
      ...
      await runtime.events.publish('command.prepared', prepared.id, <String, dynamic>{
        'commandId': prepared.id,
        'projectId': project.id,
