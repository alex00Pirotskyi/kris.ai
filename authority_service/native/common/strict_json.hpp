...
struct value {
  ...
  value(std::int64_t v):data(v){} value(int v):data(static_cast<std::int64_t>(v)){} value(std::string v):data(std::move(v)){}
  value(array v):data(std::move(v)){} value(object v):data(std::move(v)){}
