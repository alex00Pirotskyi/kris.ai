...
void main() {
  test('all compact production diagnostics satisfy their repaired contracts',
      () async {
    ...
    for (final file in files) {
      ...
      expect(action.arguments['path'], expected['normalizedPath'],
          reason: file.path);
        ...
        expect(
          RunRetryBudgetPolicy(
            minimumRemainingRepairs:
                int.parse(expected['minimumRemainingRepairs'].toString()),
