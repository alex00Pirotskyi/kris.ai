...
void main() {
  test(
    'research executes retrieval verification and synthesis as graph nodes',
    () async {
      final specification = TaskSpecification(
        id: 'spec-research',
        originalRequest:
            'Compare current Flutter and Dart release information.',
  ...
  test(
    'diagnostics collects one real report and propagates it through graph',
    () async {
      final specification = TaskSpecification(
        id: 'spec-diagnostics',
