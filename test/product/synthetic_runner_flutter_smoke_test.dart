...
void main() {
  final enabled =
      Platform.environment['KRISTIN_RUN_REAL_FLUTTER_SMOKE'] == '1';
  ...
  test(
    ...
    () async {
      ...
      final model = ModelIdentity(
        providerId: 'recorded-flutter-smoke',
      ...
      : _actions = <String, List<Map<String, Object?>>>{
          'Inspect project and establish evidence baseline':
            ...
            <String, Object?>{
              ...
              'reason': 'Confirm that the selected project root is blank.',
            },
            <String, Object?>{
              'action': 'complete',
              'summary': 'The active project root is blank and inspected.',
            },
          ],
          'Implement requested product behavior': <Map<String, Object?>>[
            ...
            <String, Object?>{
              ...
              'reason':
                  'Create a deterministic project-local repair script without touching existing files directly.',
            },
            <String, Object?>{
              'action': 'tool',
              'tool': 'run_command',
              ...
              'reason':
                  'Apply the deterministic app/test fixture through finite process execution.',
            },
            <String, Object?>{
              'action': 'tool',
              'tool': 'run_command',
...
""";
  ...
  Future<ModelGenerationResult> generate(ModelGenerationRequest request) async {
    ...
    if (request.systemPrompt.contains('readiness probe')) {
      ...
      if (queue.isEmpty) {
        throw StateError('Flutter smoke script exhausted for ${entry.single.key}.');
      }
