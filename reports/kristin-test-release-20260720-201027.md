...
- Profile: `Flutter`
- Generated: `2026-07-20T17:09:51.089771+00:00`
...
| FAIL | Flutter tests | Command exited with code 1: HttpException: Connection closed while receiving data, uri = /api/generate \| HttpException: Connection closed before full header was received, uri = http://127.0.0.1:49909/api/generate \| model_load_timeout: Ollama could not finish loading tiny-model after 2 bounded attempts. Keep Ollama running, free enough memory for the model, or increase the cold-load timeout in Settings. | `flutter test --no-pub` |
